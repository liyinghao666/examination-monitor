...
!(function(t, e) {
  ...
  function i(t) {
    e.util.assert("number" == typeof t, function() {
      ...
      e.util.assert(n.indexOf(t) >= 0, function() {
        return (
          "outputStride of " + t + " is invalid. It must be either 8, 16, or 32"
        );
      });
  }
  function o(t, r) {
    e.util.assert("number" == typeof t, function() {
      ...
      e.util.assert((t - 1) % r == 0, function() {
        return (
          "resolution of " + t + " is invalid for output stride " + r + "."
        );
      });
  }
  var u = (function() {
  ...
  var a = (function() {
    ...
    return (
      ...
      (t.prototype.swim = function(t) {
        for (; t > 0 && this.less(s(t), t); )
          this.exchange(t, s(t)), (t = s(t));
      }),
  ...
  function l(t, e, r, n, i, o) {
    for (
      ...
      for (
        var h = Math.max(n - i, 0), d = Math.min(n + i + 1, a), m = h;
        m < d;
        ++m
      )
        if (o.get(p, m, t) > e) {
  ...
  function v(t, e, r) {
    var n = m(t.heatmapY, t.heatmapX, t.id, r),
      i = n.y,
      o = n.x;
  ...
  function _(t, e, r, n) {
    return {
      y: y(Math.round(t.y / e), 0, r - 1),
      x: y(Math.round(t.x / e), 0, n - 1)
    };
  }
              ...
              for (var p = 0; p < u; ++p) {
                ...
                h < t ||
                  (l(p, h, f, c, e, r) &&
                    s.enqueue({
                      score: h,
                      part: { heatmapY: f, heatmapX: c, id: p }
                    }));
              }
          return s;
        })(u, I, t),
  ...
  function T(t, r) {
    ...
    return (
      s / u < a
        ? ((f = 0),
          (c = 0),
          (p = Math.round(0.5 * (a * u - s))),
          (h = Math.round(0.5 * (a * u - s))))
        : ((f = Math.round(0.5 * ((1 / a) * s - u))),
          (c = Math.round(0.5 * ((1 / a) * s - u))),
          (p = 0),
          (h = 0)),
      {
  ...
  function K(t, r, n) {
    return e.tidy(function() {
      var i = (function(t, r) {
        for (var n = [], i = 0; i < c; i++) {
          var o = F(t.get(i, 0).valueOf(), t.get(i, 1).valueOf(), i, r),
            u = o.x,
            s = o.y;
          n.push(s), n.push(u);
        }
    ...
    return N(this, void 0, void 0, function() {
      ...
      return R(this, function(d) {
        switch (d.label) {
          case 0:
            return (
              (n = 0), (i = Y(t)), [4, Promise.all([A(t), A(e), A(i, "int32")])]
            );
          case 1:
            return (
              (o = d.sent()),
          ...
          case 2:
            return (
              ...
              (p = Array.from(
                (function(t, e) {
                  for (
                    var r = e.shape[0], n = new Float32Array(r), i = 0;
                    i < r;
                    i++
                  ) {
                    var o = e.get(i, 0),
              ...
              (h = p.map(function(t, e) {
                return (
                  (n += t),
                  {
                    position: { y: c.get(e, 0), x: c.get(e, 1) },
                    part: f[e],
                    score: t
                  }
                );
              ...
              i.dispose(),
              l.dispose(),
              [2, { keypoints: h, score: n / h.length }]
            );
        }
      });
    });
  ...
  var W = (function() {
    ...
    G = ["MobileNetV1", "ResNet50"],
    U = { MobileNetV1: [8, 16, 32], ResNet50: [32, 16] },
    L = [161, 193, 257, 289, 321, 353, 385, 417, 449, 481, 513, 801],
    J = { MobileNetV1: [0.5, 0.75, 1], ResNet50: [1] },
    Z = [1, 2, 4];
  ...
  var et = (function() {
    ...
    return (
      (t.prototype.estimateMultiplePoses = function(t, e) {
        return (
          void 0 === e && (e = tt),
          N(this, void 0, void 0, function() {
            ...
            return R(this, function(M) {
              switch (M.label) {
                case 0:
                  return (
                    ...
                    (function(t) {
                      ...
                      if (e <= 0)
                        throw new Error(
                          "Invalid maxDetections " + e + ". Should be > 0"
                        );
                      if (r < 0 || r > 1)
                        throw new Error(
                          "Invalid scoreThreshold " +
                            r +
                            ". Should be in range [0.0, 1.0]"
                        );
                      if (n <= 0)
                        throw new Error("Invalid nmsRadius " + n + ".");
                    })(e),
                    (n = this.baseModel.outputStride),
                    (u = this.inputResolution),
                    i(n),
                    o(this.inputResolution, n),
                    (s = H(t)),
                    (a = s[0]),
                    (l = s[1]),
                    (f = T(t, [u, u])),
                ...
                case 2:
                  return (
                    (E = M.sent()),
                    (S = V(E, [a, l], [u, u], p, r.flipHorizontal)),
                    d.dispose(),
                    m.dispose(),
                    v.dispose(),
                    y.dispose(),
            ...
            return R(this, function(w) {
              switch (w.label) {
                ...
                case 1:
                  return (
                    (g = w.sent()),
                    (b = V([g], [a, l], [u, u], p, r.flipHorizontal)),
                    d.dispose(),
                    m.dispose(),
                    v.dispose(),
                    y.dispose(),
      ...
      (t.prototype.estimatePoses = function(t, e) {
        return N(this, void 0, void 0, function() {
          return R(this, function(r) {
            switch (r.label) {
              case 0:
                return "single-person" != e.decodingMethod
                  ? [3, 2]
                  : [4, this.estimateSinglePose(t, e)];
              case 1:
                return [2, [r.sent()]];
              case 2:
      ...
      return R(this, function(f) {
        switch (f.label) {
          case 0:
            ...
            return (
              (s = (function(t, e, r) {
                var n = { 1: "100", 0.75: "075", 0.5: "050" },
                  i = "model-stride" + t + ".json";
                return 4 == r
                  ? X + "float/" + n[e] + "/" + i
                  : X + "quant" + r + "/" + n[e] + "/" + i;
              })(n, o, i)),
              [4, r.loadGraphModel(t.modelUrl || s)]
            );
          case 1:
            return (
              (a = f.sent()),
              (l = new u(a, n)),
              [2, new et(l, t.inputResolution)]
            );
        }
      });
    });
  ...
  function nt(t) {
    return N(this, void 0, void 0, function() {
      ...
      return R(this, function(a) {
        switch (a.label) {
          case 0:
            if (((n = t.outputStride), (i = t.quantBytes), null == e))
              throw new Error(
                "Cannot find TensorFlow.js. If you are using a <script> tag, please also include @tensorflow/tfjs on the page before using this\n        model."
              );
            return (
          ...
          case 1:
            return (
              (u = a.sent()),
              (s = new W(u, n)),
              [2, new et(s, t.inputResolution)]
            );
        }
      });
    });
  }
  (t.decodeMultiplePoses = O),
    (t.decodeSinglePose = Q),
    (t.MobileNet = u),
    (t.partChannels = [
      "left_face",
      "right_face",
        ...
        N(this, void 0, void 0, function() {
          return R(this, function(e) {
            return "ResNet50" ===
              (t = (function(t) {
                if (
                  (null == (t = t || C).architecture &&
                    (t.architecture = "MobileNetV1"),
                  G.indexOf(t.architecture) < 0)
                )
                  throw new Error(
                ...
                if (
                  (null == t.inputResolution && (t.inputResolution = 257),
                  L.indexOf(t.inputResolution) < 0)
                )
                  throw new Error(
                    "Invalid inputResolution " +
                      t.inputResolution +
                      ". Should be one of " +
                      L
                  );
                if (
                  ...
                  U[t.architecture].indexOf(t.outputStride) < 0)
                )
                  throw new Error(
                ...
                if (
                  ...
                  J[t.architecture].indexOf(t.multiplier) < 0)
                )
                  throw new Error(
                    "Invalid multiplier " +
                      t.multiplier +
    ...
    (t.PoseNet = et),
    (t.VALID_INPUT_RESOLUTION = L),
    (t.getAdjacentKeyPoints = function(t, e) {
      return d.reduce(function(r, n) {
        var i = n[0],
          o = n[1];
        return (function(t, e, r) {
          return t < r || e < r;
        })(t[i].score, t[o].score, e)
          ? r
          : (r.push([t[i], t[o]]), r);
      }, []);
    }),
    (t.getBoundingBox = z),
    (t.getBoundingBoxPoints = function(t) {
      var e = z(t),
        r = e.minX,
        n = e.minY,
        i = e.maxX,
